<template lang="pug">
  .hello
    ...
    ul
      li
        a(href='https://www.npmjs.com/package/vuetify' target='_blank' rel='noopener') vuetify
      li
        a(href='https://www.npmjs.com/package/pug' target='_blank' rel='noopener') pug
      li
        a(href='https://www.npmjs.com/package/vue-axios' target='_blank' rel='noopener') vue-axios
      li
